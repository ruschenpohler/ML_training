...
Central issue: In **high-dimensional environments**, we need to find ways to come up with **sparse models** that predict outcomes well in **new data**.
...
* Scenario: Experimental study, high-dimensional data with $p_{large}>n$
...
- Similar literature: Bias reduction in instrumental variables estimation (e.g., Spiess, 2017)
...
Papers:
  + Athey and Imbens(PNAS 2016) "Recursive Partitioning for Heterogeneous Causal Effects"
  + Wagner and Athey (JASA 2017) "Estimation and Inference of Heterogeneous Treatment Effects using Random Forests"
  + Davis and Heller (AER 2017) "Using Causal Forests to Predict Treatment Heterogeneity"
...
### Decision Heuristics Based on ML (Ludwig et al., AEAPP 2019)
