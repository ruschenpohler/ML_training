...
We need ways to generate **sparse models** that predict well in **high-dimensional space** (~many predictors).
...
* Scenario: Experimental study with selection into take-up, high-dimensional data with $p>n$
...
* Literature: e.g., Chen and Liu, 2016
...
Many ML papers are weak on identification side
  + **Strong ignorability assumption** (with optimized set of control variables)

### Selective Labels for the Tested

Many big data sets represent a restricted universe
