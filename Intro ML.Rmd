...
### Predicting Poverty (Blumenstock, Cadamuro, and On, Science 2015)
...
Delete test sample Y matrix on ML slide!
...
library(png)
library(grid)
Blum <- readPNG("pics/B2015_distrib.png")
grid.raster(Blum, x = unit(0.5, "npc"), y = unit(0.5, "npc"), width = 1, height = 1,)
```
