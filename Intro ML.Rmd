...
Given some set of predictors, we would like to predict an outcome: $\mathbb { E } \left[ v _ { i } | x _ { i } \right]$.

That is, what is $v _ { i }$ given $x _ { i }$?

- Example:
+ What impact does policy $x _ { i }$ have on outcome $v _ { i }$?
+ Does predictor $x _ { i }$ influence behavior $v _ { i }$?
...
Regularization: $K _ { j } \left( \beta _ { j } \right)$ is a cost fct that defines the penalty regime
