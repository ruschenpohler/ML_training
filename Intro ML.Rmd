...
We need ways to generate **sparse (~parsimonious) models** that predict well in **high-dimensional space** (~many predictors).
...
* Goal: Find best set of predictors $p_{small} \ll n$ to predict take-up
...
Many ML papers are weak on the identification side
  ...
  + Only difference: Optimized set of predictors drawing on the set of all measured predictors
